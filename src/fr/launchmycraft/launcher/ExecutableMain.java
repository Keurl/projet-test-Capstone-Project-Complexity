...
public class ExecutableMain {
	...
	private static final long DEFAULT_ID = 55702;
    ...
    DocumentListener textListener = new DocumentListener(){
		...
		public void insertUpdate(DocumentEvent arg0) {
            Util.computeLoginButtonAvaibility(loginButton, usernameField, passwordField, launcherDetails);
	...
	{		
		...
		public void lastVers() throws Exception {
		...
		public final JPanel logs() throws JsonSyntaxException, IOException {
		...
		public void credentials(JPanel contentPane) throws Exception {
			
			Credentials storedCredentials = Util.getStoredCredentials(launcherId, hasPaid, identifier);
            ...
            else
            {
            	...
            	String newToken = Util.refreshCredentials(storedCredentials, launcherDetails);
            	if (newToken != null)
            	{              	
                	//Si c'est bon
            		//On sauvegarde le nouveau token
            		storedCredentials.accesstoken = newToken;
            		Util.setStoredCredentials(launcherId, storedCredentials, hasPaid, identifier);
            		...
            		logout.addActionListener(new ActionListener(){
						...
						public void actionPerformed(ActionEvent e) {
							try
							{
								...
								Util.setStoredCredentials(launcherId, new Credentials(), hasPaid, identifier);
								account = null;
		...
		public void run()
		{
			...
			{										
				...
				*/	
				...
				//Le logo du serveur			
                bottomPanel.add(Util.getLogoJLabel(launcherDetails, true), BorderLayout.WEST); 
                ...
                if (Util.isCrackedAllowed(launcherDetails))
                {
                ...
                */
				...
				Configuration config = Util.getConfiguration(hasPaid, identifier);
				...
				if (config.cguRevision < latestCgu)
				{
					...
					else
					{
						...
						Util.saveConfiguration(config, hasPaid, identifier);
					}
				}
			}
			catch (Exception ex)
	...
	void doLogin()
	{
		...
		StateListener stateListener = new StateListener()
		{
			...
			public void onStateChanged(boolean failed, String text, boolean onLogin) 
			{
				...
				{
					LoggerUtils.println("### ERREUR A L'ESSAI " + (errorsCount + 1) + " ! ###");
